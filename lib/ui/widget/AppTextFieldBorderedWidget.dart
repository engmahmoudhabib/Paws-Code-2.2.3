...
class AppTextFieldBorderedWidget extends StatefulWidget {
  ...
  @override
  _AppTextFieldBorderedState createState() => _AppTextFieldBorderedState();
}

class _AppTextFieldBorderedState extends State<AppTextFieldBorderedWidget> {
  @override
        ...
        Container(
          decoration: widget.supportDecoration
              ? BoxDecoration(
                  ...
                  border:
                      Border.all(width: 0.3, color: const Color(0x8a707070)),
                )
              : null,
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(
                        ...
                        fontSize: AppFactory.getFontSize(
                                widget.hint.length == 0 ? 0 : 20, toString())
                            .h,
                        color: widget.enable
                    ...
                    labelStyle: TextStyle(
                        ...
                        fontFamily: FontFamily.araHamahAlislam,
                        fontSize: AppFactory.getFontSize(
                                widget.name.length == 0 ? 0 : 20, toString())
                            .h,
                        color: widget.enable
                            ? AppFactory.getColor('gray', toString())
                            : AppFactory.getColor('gray_1', toString())),
